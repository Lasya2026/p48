...
var ropeImage,rope;
var ground;
var line1,line3,line4,line5,line6,line7,line8,line9,line10,line11,line12,line13;
...
back1=loadImage("images/startBack.png");
back3=loadImage("images/b.png");
...
function setup() {
 //gameState starts------------
  ...
  line33=createSprite(304, 247,5, 30);
  line33.velocityY=-1;
  ...
  line54=createSprite(398, 90, 30,5);
  line54.velocityX=-1;
...
function draw() {
  background(back1);
   if (gameState === "start"){
    start=createSprite(232,358,50,50);
  ...
  start.scale=0.3;
      ...
      // keyDowns for thief to move up,down,left and right--------
      if(keyDown("up_arrow")){
      thief.y=thief.y-2;
      ...
      //isTouhing part where we collide some sprites------------------
      ...
      if(fireball1.isTouching(ghost1)||
